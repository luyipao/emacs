...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "preview" '("preview-" "TeX-" "desktop-buffer-preview-misc-data")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "tex" '("TeX-" "LaTeX-" "Bib" "docTeX-default-extension" "plain-TeX-auto-regexp-list" "VirTeX-common-initialization" "tex-" "ConTeXt-")))
